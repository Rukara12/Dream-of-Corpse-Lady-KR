...
**Windows의 PC 보호** 창이 뜨면 **자세히 → 실행**을 누릅니다.
서명되지 않은 프로그램이 게임 파일을 수정하기 때문에 나타나는 경고입니다.
...
스팀이 게임을 업데이트하면 패치가 원래대로 돌아갑니다. 패처를 다시 실행하면 됩니다.

원본은 게임 폴더의 `한글패치_원본백업/`에 보관됩니다.
...
패처 소스는 MIT입니다. 포함된 저작물의 조건은 [THIRD-PARTY.md](THIRD-PARTY.md)를 참고하십시오.
이 저장소는 게임 원본 파일을 포함하지 않으며, 시희지몽의 모든 권리는 원 개발사에 있습니다.
